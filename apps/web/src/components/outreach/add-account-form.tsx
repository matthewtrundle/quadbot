      ...
      <CardContent className="space-y-3">
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <Input value={form.from_name} onChange={e => setForm(f => ({ ...f, from_name: e.target.value }))} placeholder="John Smith" />
          </div>
          <div>
            <Label>Email</Label>
        ...
        <div>
          ...
          <Input type="password" value={form.resend_api_key} onChange={e => setForm(f => ({ ...f, resend_api_key: e.target.value }))} placeholder="re_..." />
        </div>
        <div>
